    ...
    if (categories.length === 0) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <a href="/admin" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold text-lg rounded-2xl hover:from-blue-700 hover:to-cyan-600 transition-all shadow-xl hover:shadow-2xl hover:scale-105">
    ...
    return (<section className="py-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <Swiper modules={[Navigation, Pagination, Autoplay]} spaceBetween={30} slidesPerView={1} navigation pagination={{ clickable: true }} autoplay={{
            delay: 3000,
                  ...
                  <div className="relative bg-white rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden group h-full">
                    ...
                    <div className="p-8">
                      ...
                      <div className="flex items-center justify-between">
                        <Link to={`/products/category/${category.id}`} className="text-blue-600 font-bold hover:text-blue-700 flex items-center gap-2 group-hover:gap-3 transition-all">
                          مشاهده محصولات
