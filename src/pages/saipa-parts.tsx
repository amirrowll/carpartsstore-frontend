...
import { EmojiEvents, LocalShipping, Build } from '@mui/icons-material';
...
const SaipaPartsPage: React.FC = () => {
  const [products, setProducts] = useState<Product[]>(sampleProducts.filter((p) => p.brand === 'Saipa'));

  useEffect(() => {
    productApi
      .getProductsByBrand('Saipa', 24)
      .then((data) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 py-10">
        <section className="rounded-[32px] bg-gradient-to-r from-orange-400 to-red-500 p-8 md:p-10 text-white shadow-2xl mb-10">
          <h1 className="text-3xl md:text-4xl font-extrabold">لوازم سایپا</h1>
          <p className="mt-4 max-w-2xl text-base md:text-lg text-orange-100/90">
            قطعات ویژه سایپا با طراحی مدرن و رنگبندی جذاب تا تجربه خرید سریعتر و مطمئن تری داشته باشید.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <div className="rounded-2xl md:rounded-3xl bg-white/10 p-4 md:p-5 text-center flex flex-col items-center justify-center">
              ...
              <h3 className="font-bold">کیفیت تضمین شده</h3>
            </div>
            <div className="rounded-2xl md:rounded-3xl bg-white/10 p-4 md:p-5 text-center flex flex-col items-center justify-center">
              <LocalShipping className="text-2xl mb-2 text-white" />
              <h3 className="font-bold">ارسال فوری</h3>
            </div>
            <div className="rounded-2xl md:rounded-3xl bg-white/10 p-4 md:p-5 text-center flex flex-col items-center justify-center">
              <Build className="text-2xl mb-2 text-white" />
              <h3 className="font-bold">پشتیبانی حرفه ای</h3>
            </div>
          </div>
        </section>
