...
import { Plus, Edit, Trash2, Eye, Star, Tag, Package, Layers, LogOut } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all flex items-center gap-2"
              disabled={loading}
            >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="موتور, پراید, گیربکس"
                        disabled={loading}
                      />
                    </div>
