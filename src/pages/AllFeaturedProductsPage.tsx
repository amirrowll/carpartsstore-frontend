...
const AllFeaturedProductsPage: React.FC = () => {
        ...
        {products.length === 0 ? (
          <div className="mt-10 text-center py-16 bg-gray-50 rounded-2xl">
            ...
            <Link 
              ...
              className="px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white font-medium rounded-lg hover:from-green-600 hover:to-green-700 transition-all"
            >
              ایجاد محصول جدید
            </Link>
          </div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {products.map((product) => (
              <div key={product.id} className="rounded-[28px] border border-gray-200 bg-white p-6 shadow-sm transition-all hover:-translate-y-2 hover:shadow-xl group">
                {/* Featured Badge */}
