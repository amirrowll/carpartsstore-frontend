...
import { 
  Folder, Plus, Edit, Trash2, Eye, Grid, 
      ...
      <div className="rounded-2xl bg-gradient-to-br from-emerald-900 to-emerald-800 p-6 shadow-2xl text-white">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-white text-emerald-900 px-5 py-3 font-medium hover:bg-gray-100 transition-colors"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-medium rounded-xl hover:from-emerald-700 hover:to-emerald-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
              >
                {formLoading ? (
                  <>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="جستجو در نام یا توضیحات دسته بندیها..."
        ...
        {loading ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filteredCategories.map((category) => (
              <div key={category.id} className="rounded-xl border border-gray-200 bg-white overflow-hidden hover:shadow-lg transition-shadow">
                {/* Category Image */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-6">
              ...
              {deleteModal.categoryId && categories.find(c => c.id === deleteModal.categoryId)?.productCount > 0 && (
            ...
            <div className="flex gap-3">
              {categories.find(c => c.id === deleteModal.categoryId)?.productCount === 0 && (
                <button
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 ${categories.find(c => c.id === deleteModal.categoryId)?.productCount === 0 ? 'bg-gray-100 text-gray-700 hover:bg-gray-200' : 'bg-blue-600 text-white hover:bg-blue-700'} font-medium rounded-xl transition-colors`}
              >
