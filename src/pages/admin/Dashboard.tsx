  ...
  return (
    <div className="space-y-8">
      ...
      <StoriesSection 
        position="top"
        showAddButton={true}
        onAddStory={() => window.location.href = '/admin/stories/create'}
      />
      ...
      <div className="grid gap-4 xl:grid-cols-2">
          ...
          <div className="space-y-3">
            {loading ? (
              ...
              stats.latestProducts.map((product) => (
                <div key={product.id} className="rounded-xl border border-gray-200 bg-gray-50 p-4 hover:bg-gray-100 transition-colors">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg">
          ...
          <div className="space-y-4">
            {loading ? (
              <div className="text-center py-8 text-gray-500">در حال بارگذاری...</div>
            ) : stats.productsByCarBrand && stats.productsByCarBrand.length > 0 ? (
              stats.productsByCarBrand.map((item, index) => (
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <a 
            ...
            className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 p-4 text-white text-center font-medium hover:from-blue-700 hover:to-blue-800 transition-all hover:scale-[1.02]"
          >
            افزودن محصول جدید
          </a>
          <a 
            href="/admin/categories" 
            className="rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-700 p-4 text-white text-center font-medium hover:from-emerald-700 hover:to-emerald-800 transition-all hover:scale-[1.02]"
          >
            مدیریت دسته‌بندی‌ها
          </a>
          <a 
            href="/admin/users" 
            className="rounded-xl bg-gradient-to-r from-purple-600 to-purple-700 p-4 text-white text-center font-medium hover:from-purple-700 hover:to-purple-800 transition-all hover:scale-[1.02]"
          >
            مدیریت کاربران
          </a>
        </div>
